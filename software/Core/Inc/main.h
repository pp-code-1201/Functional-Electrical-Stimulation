...
#define charge_full_Pin GPIO_PIN_7
#define charge_full_GPIO_Port GPIOA
...
#define KEY_4_EXTI_IRQn EXTI15_10_IRQn
...
#define channel_switch_Pin GPIO_PIN_0
#define channel_switch_GPIO_Port GPIOE
